...
class InstrumentSpec:
    def __init__(self, numStrings, builder, model, gType, backWood, topWood):
...
class Instrument:
    ...
    def __init__(self, category, serialNumber, Price, spec):
    ...
    #     formatstr = 'category: {} \n serialnumber : {} \n price : {} \n numStrings : {} \n builder : {} \n model : {} \n gType : {}  \n backwood : {} \n topwood : {}'
    #     return (
    #     formatstr.format(self.category, self.serialnumber, self.price, self.numstrings, self.builder, self.model,
    #                      self.gtype, self.backwood, self.topwood))
    def __repr__(self):
        formatstr = 'category: {} \n serialnumber : {} \n price : {} \n spec : {}'
        return (formatstr.format(self.category, self.serialnumber, self.price, self.spec))


    # create function to see if 1 instrument matches input guitar
